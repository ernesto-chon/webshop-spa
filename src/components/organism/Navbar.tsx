  ...
  return (
    <nav className="relative top-0 w-screen bg-primary-gray">
      ...
      <div className="bg-white py-5">
        <div className="mx-0 flex items-center justify-center gap-5 md:container md:mx-auto">
          <div className="justify-self-end">
            <button className="d-btn rounded-none bg-[#ebebec] transition-colors !duration-300 hover:fill-primary hover:text-primary lg:text-lg">
